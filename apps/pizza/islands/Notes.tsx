    ...
    <ol className="text-gray-500 mb-2 text-sm list-decimal pl-4 space-y-3">
      <li>
        ...
        <HelpText label="tiny bit">
          ...
          described in this recipe (0.4 - 0.8 grams!). However, since we're
          storing the poolish in the fridge for more consistent temperature
          control, 5 grams of yeast isn't too much.
        </HelpText>{" "}
      ...
      <li>
        ...
        <span className={cx(skipAtolyse && "line-through")}>
          ...
          <HelpText label="extensibility">
            The dough's ability to be stretched and hold its shape without being
            so elastic that it snaps back.
      ...
      <li>
        ...
        <HelpText label="retarding">
          Place them in a cool chamber that literally <i>retards</i>{" "}
