  ...
  return (
    <div className="p-4 max-w-prose mx-auto mb-6">
      ...
      <div className="prose prose-lg">
        ...
        <ol className="list-decimal pl-5">
          <li>
            Hvis flere deltakere vinner i en kategori, vil pottprosenten for den
            kategorien fordeles mellom dem i forhold til størrelsen på deres
            individuelle innsatser.
          </li>
          <li>
        ...
        <ol className="list-decimal pl-5">
          <li>
            Finn bookie Siri og fyll ut veddemålsskjemaet med navnet ditt, dine
            forutsigelser for 1., 2. og 3. plass, og beløpet du ønsker å satse.
          </li>
